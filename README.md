...
WinXplorer is a Windows Explorer recreation (specifically, the Vista explorer) based in QtQuick, which aims to also add some useful features. Works best with [VistaThemePlasma](https://gitgud.io/catpswin56/vistathemeplasma).

## Installation 

1. Run ``chmod +x install.sh && ./install.sh``
2. The program will be installed as ``winxplorer``

## TODO

### General

1. Make the details pane show details about the currently selected file.
2. Add functionality to the navigation pane.    
3. Add the preview pane.
4. Make the command bar actually show commands for files and folders.
5. Add basic file operations (like copying, moving, etc).
6. Make the search bar functional.
...
10. Add a terminal pane (like in Dolphin).
11. Add split view support.
12. Add tabs support.
